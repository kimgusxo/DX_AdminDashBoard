package com.example.dx_admindashboard.user.controller;

import com.example.dx_admindashboard.user.domain.dto.UserDTO;
import com.example.dx_admindashboard.user.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<UserDTO> getUserListByStoreId(@PathVariable Long storeId) {
    ...
    public ResponseEntity<UserDTO> getMealKitSalesCountTop5ByUserGender(@RequestParam Long storeId,
    ...
    public ResponseEntity<UserDTO> getMealKitSalesCountTop5ByUserAge(@RequestParam Long storeId,
