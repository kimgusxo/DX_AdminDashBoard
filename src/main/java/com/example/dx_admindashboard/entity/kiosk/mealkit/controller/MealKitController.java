...
public class MealKitController {
    ...
    public ResponseEntity<List<MealKitInfoAndStoreIdAndMealKitCountProjectionDTO>> getMealKitListByStoreId(@RequestParam Long storeId) {
    ...
    public ResponseEntity<List<MealKitInfoAndStoreIdAndMealKitCountProjectionDTO>> getMealKitListByStoreIdAndMealKitCountLessThan10(@RequestParam Long storeId) {
