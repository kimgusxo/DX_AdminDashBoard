...
public class LaundrySuppliesController {
    ...
    public ResponseEntity<> getLaundrySuppliesListByStoreId(@PathVariable Long storeId) {
    ...
    public ResponseEntity<> getLaundrySuppliesSalesCountByLaundrySuppliesIdAndStoreIdAndYear(@RequestParam Long laundrySuppliesId,
    ...
    public ResponseEntity<> getLaundrySuppliesSalesCountTop5ByStoreIdAndYear(@RequestParam Long storeId,
                                                                             @RequestParam Integer year) {
    ...
    public ResponseEntity<> getLaundrySuppliesSalesCountTop5ByStoreIdAndYearAndMonth(@RequestParam Long storeId,
                                                                             @RequestParam Integer year,
