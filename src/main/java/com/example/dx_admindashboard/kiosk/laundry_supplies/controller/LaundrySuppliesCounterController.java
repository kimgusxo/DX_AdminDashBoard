...
import com.example.dx_admindashboard.kiosk.laundry_supplies.domain.dto.LaundrySuppliesCounterDTO;
import com.example.dx_admindashboard.kiosk.laundry_supplies.service.LaundrySuppliesCounterService;
...
public class LaundrySuppliesCounterController {
    ...
    public ResponseEntity<Integer> fetchLaundrySuppliesCounter(@RequestBody LaundrySuppliesCounterDTO laundrySuppliesCounterDTO) {
        log.info("fetchLaundrySuppliesCounter : laundrySuppliesCounter = {}", laundrySuppliesCounterDTO);
