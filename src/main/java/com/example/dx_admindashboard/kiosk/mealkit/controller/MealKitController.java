package com.example.dx_admindashboard.kiosk.mealkit.controller;

import com.example.dx_admindashboard.kiosk.mealkit.service.MealKitService;
...
public class MealKitController {
    ...
    public ResponseEntity<> getMealKitListByStoreId(@PathVariable Long storeId) {
    ...
    public ResponseEntity<> getMealKitSalesCountByMealKitIdAndStoreIdAndYear(@RequestParam Long mealKitId,
    ...
    public ResponseEntity<> getMealKitSalesCountTop5ByStoreIdAndYear(@RequestParam Long storeId,
                                                                     @RequestParam Integer year) {
    ...
    public ResponseEntity<> getMealKitSalesCountTop5ByStoreIdAndYearAndMonth(@RequestParam Long storeId,
                                                                             @RequestParam Integer year,
    ...
    public ResponseEntity<> getMealKitSalesRevenueTop5ByStoreIdAndYearAndMonth(@RequestParam Long storeId,
                                                                     @RequestParam Integer year,
                                                                     @RequestParam Integer month) {
    ...
    public ResponseEntity<> getMealKitSalesCountTop5ByStoreId(@RequestParam Long storeId) {
